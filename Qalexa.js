...
module.exports = {
 OB_NAME: process.env.Z_BOT_NAME === undefined ? 'Cuzier' : process.env.Z_BOT_NAME,
 ...
 OA_REPLY: process.env.Z_DEP_REPLY === undefined ? 'Yeh,En cuzier is my creator' : process.env.Z_DEP_REPLY,
